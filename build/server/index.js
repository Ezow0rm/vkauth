...
const options = {
  ...
  templates: {
    app: ({ head, body, assets: assets2, nonce, env }) => '<!DOCTYPE html>\n<html lang="en">\n	<head>\n		<meta charset="utf-8" />\n		<link rel="icon" href="' + assets2 + '/favicon.png" />\n		<meta name="viewport" content="width=device-width,initial-scale=1.0" />\n    <meta name="theme-color" content="#333333" />\n		<link rel="stylesheet" href="' + assets2 + '/phishing__/global.css" />\n    <link\n      rel="manifest"\n      href="' + assets2 + '/phishing__/manifest.json"\n      crossorigin="use-credentials"\n    />\n    <link\n      rel="shortcut icon"\n      type="image/x-icon"\n      href="' + assets2 + '/phishing__/favicon.ico"\n    />\n		' + head + '\n	</head>\n	<body data-sveltekit-preload-data="hover">\n		<div style="display: contents">' + body + "</div>\n	</body>\n</html>\n",
  ...
  version_hash: "1jjz92t"
};
function get_hooks() {
  return import('./chunks/hooks.server-26791e99.js');
}
